...
api.register(r'footer', app_views.FooterView, basename='footer')
api.register(r'sport_data', app_views.SportDataView, basename='sport_data')
api.register(r'get_sport_data', app_views.GetDataView, basename='get_sport_data')
...
api.register(r'filter_by_view', app_views.GetDataFilterByviewsView, basename='filter_by_view')
